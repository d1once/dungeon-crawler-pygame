...
class Character():
    ...
    def move(self, dx, dy, obstacle_tiles):
        ...
        # check for collision map in y direction
        self.rect.y += dy
        for obstacle in obstacle_tiles:
            # check for collision
            if obstacle[1].colliderect(self.rect):
        ...
        if self.char_type == 0:
            ...
            if self.rect.bottom > (constants.SCREEN_HEIGHT - constants.SCROLL_THRESH):
                screen_scroll[1] = (constants.SCREEN_HEIGHT -
                                    constants.SCROLL_THRESH) - self.rect.bottom
    ...
    def ai(self, player, obstacle_tiles, screen_scroll, fireball_image):
        ...
        dist = math.sqrt(((self.rect.centerx - player.rect.centerx)
                         ** 2) + ((self.rect.centerx - player.rect.centerx) ** 2))
    ...
    def draw(self, surface):
        ...
        if self.char_type == 0:
            surface.blit(flipped_image, (self.rect.x,
                         self.rect.y - constants.SCALE * constants.OFFSET))
        else:
